...
# When solving for power, neither of the sample size sliders update their corresponding numeric input or calculate the power. However, updating the numeric input updates the slider input and calculates the power.
    ...
    output$TP = renderUI({
      list(
        ...
        box(
          ...
          numericInput(inputId = "N1_N_TP", label = "Sample Size One", min = 0, max = 5000, value = 100, step = 1),
          sliderInput(inputId = "N1_S_TP", label = "", min = 0, max = 5000, value = 100, step = 1),
          ...
          if(input$solvefor_TP == "Power"){
            list(numericInput(inputId = "N2_N_TP", label = "Sample Size Two", min = 0, max = 5000, value = 695, step = 1),
                 sliderInput(inputId = "N2_S_TP", label = "", min = 0, max = 5000, value = 695, step = 1))},
          ...
          if(input$solvefor_TP == "Sample Size"){
            list(numericInput(inputId = "power_N_TP", label = "Power", min = 0, max = 1, value = 0.8, step = 0.05),
